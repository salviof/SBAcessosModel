...
public abstract class UtilFabricaDeAcoes {
    ...
    public static ComoAcaoSecundaria getAcaoSecundaria(FabTipoAcaoSistemaGenerica pTipoAcao, ItfAcaoGerenciarEntidade pAcaoPrincipal, ComoFabricaAcoes pAcao) {
        ...
        String nomeDoObjeto = UtilCRCReflexao.getNomeDoObjeto(pAcaoPrincipal.getClasseRelacionada());
        ...
        switch (pTipoAcao) {
            ...
            case SALVAR_EDICAO:
                ...
                novaAcaoRefController.setIdMetodo(UtilCRCReflexao.getMetodoByAcao(novaAcaoRefController));
                break;
            case SALVAR_NOVO:
                novaAcao = new AcaoDeEntidadeController(pAcaoPrincipal);
                novaAcao.configurarPropriedadesBasicas(novaAcao);
