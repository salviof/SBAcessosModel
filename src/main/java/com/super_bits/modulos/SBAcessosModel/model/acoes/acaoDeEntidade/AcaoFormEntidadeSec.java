...
public class AcaoFormEntidadeSec extends AcaoSecundaria implements ItfAcaoFormularioEntidadeSecundaria {
    ...
    public AcaoFormEntidadeSec(ItfAcaoGerenciarEntidade pAcaoPrincipal, ComoFabricaAcoes pFabricaAcao, String pXhtml) {
    ...
    public AcaoFormEntidadeSec(ItfAcaoGerenciarEntidade pAcaoPrincipal, ComoFabricaAcoes pFabricaAcao) {
        super(pAcaoPrincipal.getClasseRelacionada(), FabTipoAcaoSistema.ACAO_ENTIDADE_FORMULARIO, pFabricaAcao);

    }

    public AcaoFormEntidadeSec(ItfAcaoGerenciarEntidade pAcaoPrincipal, ComoFabricaAcoes pFabricaAcao, FabTipoAcaoSistemaGenerica acaoGenerica) {
     ...
     * @param pXhtml
     */
    public AcaoFormEntidadeSec(Class pclasse, ComoFabricaAcoes pFabricaAcao, String pXhtml) {
    ...
    public AcaoFormEntidadeSec(Class pclasse, ComoFabricaAcoes pFabricaAcao) {
        super(pclasse, FabTipoAcaoSistema.ACAO_ENTIDADE_FORMULARIO, pFabricaAcao);
